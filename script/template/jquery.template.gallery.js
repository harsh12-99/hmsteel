...
(function ($, doc, win) {
  ...
  var templateGallery = function (object, option) {
        ...
        image
          .one("load", function () {
            if (++i === componentLength) {
              ...
              var filterList = $this.children(
                ".template-component-gallery-filter-list"
              );
    ...
    this.setSelected = function (object) {
      $this
        .find(".template-component-gallery-filter-list>li a")
        .removeClass("template-state-selected");
    ...
    this.createIsotope = function (filter, bind) {
      ...
      imageList
        .children("li.template-component-gallery-image-list-width-2")
        .css("max-width", columnWidth * 2 + glutter);
      ...
      Isotope.Item.prototype.reveal = function () {
        ...
        link
          .attr("data-fancybox-group", link.attr("data-fancybox-group-temp"))
          .removeAttr("data-fancybox-group-temp");
      };
      ...
      Isotope.Item.prototype.hide = function () {
        ...
        var link = $(this.element).find("a");
        link
          .attr("data-fancybox-group-temp", link.attr("data-fancybox-group"))
